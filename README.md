<h1 align="center">Theo Poulopoulos</h1>

<p align="center">
  Senior Data Analyst in fraud &amp; risk · I build AI products end to end
</p>
...
- 🛡️ Fraud &amp; risk analytics at **Domestic and General**. Previously **Zempler Bank**, **Barclays**, **NHS Digital**
- 🎓 MSc Data Science &amp; Analytics, Cardiff · BSc Mathematics, University of Crete
- 🤖 Building production apps with LLM APIs — retrieval-grounded assistants, prompt evaluation, agentic workflows
- 📍 London, UK
...
| **Frontis** | Scheduling and teaching tool for solo private tutors in Greece. Phone-first lesson management, plus a RAG pipeline over indexed syllabus documents that generates grounded practice exams and quizzes. | closed alpha |
